...
public interface NetworkService {
    ...
    @GET("/user/get_open_place_card.php") //오픈 장소카드 인덱스 가져오기
    Call<OpenPlaceCard> getOpenPlaceCard(@Query("user_id") String user_id);
    ...
    @GET("/user/update_place_card.php") //장소 카드 오픈하기
    Call<String> updatePlaceCardState(@Query("user_id") String user_id, @Query("place_card_idx") int place_card_idx);
