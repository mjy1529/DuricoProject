...
public class ListAdapterStoryList extends BaseAdapter {
    LayoutInflater inflater = null;
    private ArrayList<ItemDataStoryList> m_oData = null;
    private int nListCnt = 0;

    public ListAdapterStoryList(ArrayList<ItemDataStoryList> _oData)
    {
        m_oData = _oData;
